    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('sw', 'Swahili'), ('en-gb', 'British English'), ('en', 'English'), ('mas', 'Maasai'), ('ry', 'Runyakitara'), ('lg', 'Ganda'), ('rny', 'Runyankore')], help_text='The language used for the consent process will also be used during data collection.', max_length=25, verbose_name='Language of consent')),
                ...
                ('version', models.CharField(editable=False, help_text="See 'consent definition' for consent versions by period.", max_length=10, verbose_name='Consent version')),
                ('update_versions', models.BooleanField(default=False)),
                ('consent_definition_name', models.CharField(editable=False, max_length=50, null=True, verbose_name='Consent definition')),
                ('model_name', models.CharField(editable=False, help_text='label_lower of this model class. Will be different if instance has been added/edited via a proxy model', max_length=50, null=True, verbose_name='model')),
                ...
                ('screening_identifier', models.CharField(db_index=True, max_length=50, validators=[django.core.validators.RegexValidator('^[A-Z0-9]+$')], verbose_name='Screening identifier')),
                ...
                ('ethnicity', models.CharField(default='black', editable=False, help_text='fromm screening', max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dm_comment', models.CharField(editable=False, help_text='see also edc.data manager.', max_length=150, null=True, verbose_name='Data Management comment')),
                ('consent_identifier', models.UUIDField(default=uuid.uuid4, editable=False, help_text='A unique identifier for this consent instance')),
                ('screening_identifier', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator('^[A-Z0-9]+$')], verbose_name='Screening identifier')),
                ('screening_datetime', models.DateTimeField(editable=False, null=True, verbose_name='Screening datetime')),
                ('group_identifier', models.CharField(max_length=50, null=True)),
                ('ethnicity', models.CharField(default='black', editable=False, help_text='fromm screening', max_length=15, null=True)),
                ('completed_by_next_of_kin', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', editable=False, max_length=10)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['modified', 'created'], name='intecomm_co_modifie_45691e_idx'),
        ),
        migrations.AddIndex(
            model_name='subjectconsent',
            index=models.Index(fields=['user_modified', 'user_created'], name='intecomm_co_user_mo_5935e6_idx'),
        ),
        migrations.AddIndex(
            model_name='subjectconsent',
            index=models.Index(fields=['subject_identifier', 'legal_name', 'dob', 'initials', 'version'], name='intecomm_co_subject_c503bc_idx'),
        ),
        migrations.AddConstraint(
            model_name='subjectconsent',
            constraint=models.UniqueConstraint(fields=('subject_identifier', 'version'), name='intecomm_consent_subjectconsent_subj_ver_uniq'),
        ),
        migrations.AddConstraint(
            model_name='subjectconsent',
            constraint=models.UniqueConstraint(fields=('legal_name', 'initials', 'version'), name='intecomm_consent_subjectconsent_legal_name_uniq'),
        ),
    ]
